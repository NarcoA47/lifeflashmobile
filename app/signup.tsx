    ...
    return (
        <View style={styles.container}>
            ...
            <Card style={styles.card}>
                <Card.Content>
                    ...
                    <TextInput
                        ...
                        mode="outlined"
                        theme={{
                            colors: { primary: customColors.button, error: customColors.error },
                    ...
                    <View style={styles.passwordContainer}>
                        ...
                        <TouchableOpacity onPress={toggleSecureTextEntry} style={styles.eyeIcon}>
                            <Icon name={secureTextEntry ? "eye-outline" : "eye-off-outline"} size={24} color={customColors.button} />
                        </TouchableOpacity>
                    </View>
            ...
            <Button
                ...
                theme={{
                    colors: { primary: customColors.button, text: customColors.text },
